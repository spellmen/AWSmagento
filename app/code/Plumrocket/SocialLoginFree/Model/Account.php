...
class Account extends \Magento\Framework\Model\AbstractModel
{
    ...
    public function getButton()
    {
        ...
        // ..checkout
        $checkoutBtn = $this->_helper->getConfig($this->_helper->getConfigSectionId() .'/'. $this->_type .'/checkout_btn');
        $image['register'] = $checkoutBtn? $media . $checkoutBtn : null;
        ...
        return [
            ...
            'checkout_text' => $this->_helper->getConfig($this->_helper->getConfigSectionId() .'/'. $this->_type .'/checkout_btn_text'),
