...
class Data extends Main
{
    ...
    public function forCheckoutEnabled()
    {
        return (bool)$this->getConfig($this->_configSectionId .'/general/enable_for_checkout');
    }
    ...
    public function modulePositionEnabled($position)
    {
        ...
        switch($position) {
            ...
            case 'checkout':
                $this->forCheckoutEnabled() or $enabled = false;
                break;
        }
    ...
    public function getRedirect()
    {
        return [
            ...
            'checkout' => $this->getConfig($this->_configSectionId .'/general/redirect_for_checkout'),
            'checkout_link' => $this->getConfig($this->_configSectionId .'/general/redirect_for_checkout_link'),
        ];
    }
